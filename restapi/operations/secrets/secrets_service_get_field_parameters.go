...
// SecretsServiceGetFieldParams contains all the bound params for the secrets service get field operation
// typically these are obtained from a http.Request
//
// swagger:parameters SecretsService_GetField
...
//
// To ensure default values, the struct must have been initialized with NewSecretsServiceGetFieldParams() beforehand.
func (o *SecretsServiceGetFieldParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
    var res []error
    ...
    qNoAutoCheckout, qhkNoAutoCheckout, _ := qs.GetOK("noAutoCheckout")
    if err := o.bindNoAutoCheckout(qNoAutoCheckout, qhkNoAutoCheckout, route.Formats); err != nil {
        res = append(res, err)
    }
...
func (o *SecretsServiceGetFieldParams) bindAutoCheckIn(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
...
func (o *SecretsServiceGetFieldParams) bindAutoCheckout(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceGetFieldParams) bindAutoComment(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceGetFieldParams) bindForceCheckIn(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceGetFieldParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceGetFieldParams) bindIncludeInactive(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
// bindNoAutoCheckout binds and validates parameter NoAutoCheckout from query.
func (o *SecretsServiceGetFieldParams) bindNoAutoCheckout(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
    ...
    value, err := swag.ConvertBool(raw)
    if err != nil {
        return errors.InvalidType("noAutoCheckout", "query", "bool", raw)
    }
    o.NoAutoCheckout = &value

    return nil
}

// bindSecretPath binds and validates parameter SecretPath from query.
func (o *SecretsServiceGetFieldParams) bindSecretPath(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceGetFieldParams) bindSlug(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
