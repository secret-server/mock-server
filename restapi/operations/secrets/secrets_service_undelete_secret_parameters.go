...
// SecretsServiceUndeleteSecretParams contains all the bound params for the secrets service undelete secret operation
// typically these are obtained from a http.Request
//
// swagger:parameters SecretsService_UndeleteSecret
...
//
// To ensure default values, the struct must have been initialized with NewSecretsServiceUndeleteSecretParams() beforehand.
func (o *SecretsServiceUndeleteSecretParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SecretsServiceUndeleteSecretParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *SecretsServiceUndeleteSecretParams) bindSecretPath(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
