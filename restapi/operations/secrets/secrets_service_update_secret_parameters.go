...
// SecretsServiceUpdateSecretParams contains all the bound params for the secrets service update secret operation
// typically these are obtained from a http.Request
//
// swagger:parameters SecretsService_UpdateSecret
...
//
// To ensure default values, the struct must have been initialized with NewSecretsServiceUpdateSecretParams() beforehand.
func (o *SecretsServiceUpdateSecretParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
    var res []error
    ...
    if runtime.HasBody(r) {
        defer r.Body.Close()
        var body models.SecretUpdateArgs
...
func (o *SecretsServiceUpdateSecretParams) bindAutoCheckIn(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
...
func (o *SecretsServiceUpdateSecretParams) bindAutoCheckout(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceUpdateSecretParams) bindAutoComment(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceUpdateSecretParams) bindForceCheckIn(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceUpdateSecretParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceUpdateSecretParams) bindSecretPath(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
