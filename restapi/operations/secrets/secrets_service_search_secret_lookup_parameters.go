...
// SecretsServiceSearchSecretLookupParams contains all the bound params for the secrets service search secret lookup operation
// typically these are obtained from a http.Request
//
// swagger:parameters SecretsService_SearchSecretLookup
...
//
// To ensure default values, the struct must have been initialized with NewSecretsServiceSearchSecretLookupParams() beforehand.
func (o *SecretsServiceSearchSecretLookupParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
    var res []error
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterAllowDoubleLocks(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterDoNotCalculateTotal(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterDoubleLockID(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterExtendedFields(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterExtendedTypeID(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterFolderID(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterHeartbeatStatus(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterIncludeActive(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterIncludeInactive(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterIncludeRestricted(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterIncludeSubFolders(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterIsExactMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterOnlyRPCEnabled(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterOnlySecretsCheckedOutByUser(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterOnlySharedWithMe(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
//
// Arrays are parsed according to CollectionFormat: "multi" (defaults to "csv" when empty).
func (o *SecretsServiceSearchSecretLookupParams) bindFilterPasswordTypeIds(rawData []string, hasKey bool, formats strfmt.Registry) error {
    // CollectionFormat: multi
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterPermissionRequired(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterScope(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterSearchField(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterSearchFieldSlug(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterSearchText(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterSecretTemplateID(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindFilterSiteID(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindSkip(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindSortBy0Direction(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindSortBy0Name(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindSortBy0Priority(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceSearchSecretLookupParams) bindTake(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
