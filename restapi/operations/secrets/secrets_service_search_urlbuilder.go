...
// SecretsServiceSearchURL generates an URL for the secrets service search operation
type SecretsServiceSearchURL struct {
...
func (o *SecretsServiceSearchURL) WithBasePath(bp string) *SecretsServiceSearchURL {
    o.SetBasePath(bp)
    return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *SecretsServiceSearchURL) SetBasePath(bp string) {
    o._basePath = bp
}

// Build a url path and query string
func (o *SecretsServiceSearchURL) Build() (*url.URL, error) {
    var _result url.URL
...
func (o *SecretsServiceSearchURL) Must(u *url.URL, err error) *url.URL {
    if err != nil {
        panic(err)
    }
    if u == nil {
...
func (o *SecretsServiceSearchURL) String() string {
    return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *SecretsServiceSearchURL) BuildFull(scheme, host string) (*url.URL, error) {
    if scheme == "" {
        return nil, errors.New("scheme is required for a full url on SecretsServiceSearchURL")
    }
    if host == "" {
        return nil, errors.New("host is required for a full url on SecretsServiceSearchURL")
    }
...
func (o *SecretsServiceSearchURL) StringFull(scheme, host string) string {
