...
// SecretsServiceGetFieldURL generates an URL for the secrets service get field operation
type SecretsServiceGetFieldURL struct {
	ID   int32
	Slug string
...
func (o *SecretsServiceGetFieldURL) WithBasePath(bp string) *SecretsServiceGetFieldURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *SecretsServiceGetFieldURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *SecretsServiceGetFieldURL) Build() (*url.URL, error) {
	var _result url.URL
	...
	if id != "" {
		...
		return nil, errors.New("id is required on SecretsServiceGetFieldURL")
	}
	...
	if slug != "" {
		...
		return nil, errors.New("slug is required on SecretsServiceGetFieldURL")
	}
...
func (o *SecretsServiceGetFieldURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *SecretsServiceGetFieldURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *SecretsServiceGetFieldURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on SecretsServiceGetFieldURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on SecretsServiceGetFieldURL")
	}
...
func (o *SecretsServiceGetFieldURL) StringFull(scheme, host string) string {
