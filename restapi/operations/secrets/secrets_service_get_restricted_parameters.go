...
// SecretsServiceGetRestrictedParams contains all the bound params for the secrets service get restricted operation
// typically these are obtained from a http.Request
//
// swagger:parameters SecretsService_GetRestricted
...
//
// To ensure default values, the struct must have been initialized with NewSecretsServiceGetRestrictedParams() beforehand.
func (o *SecretsServiceGetRestrictedParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
    var res []error
...
func (o *SecretsServiceGetRestrictedParams) bindAutoCheckIn(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
...
func (o *SecretsServiceGetRestrictedParams) bindAutoCheckout(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceGetRestrictedParams) bindAutoComment(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceGetRestrictedParams) bindForceCheckIn(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceGetRestrictedParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
...
func (o *SecretsServiceGetRestrictedParams) bindSecretPath(rawData []string, hasKey bool, formats strfmt.Registry) error {
    var raw string
    if len(rawData) > 0 {
        raw = rawData[len(rawData)-1]
    }
