...
// RolesServiceGetRolePermissionsParams contains all the bound params for the roles service get role permissions operation
// typically these are obtained from a http.Request
//
// swagger:parameters RolesService_GetRolePermissions
...
//
// To ensure default values, the struct must have been initialized with NewRolesServiceGetRolePermissionsParams() beforehand.
func (o *RolesServiceGetRolePermissionsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RolesServiceGetRolePermissionsParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *RolesServiceGetRolePermissionsParams) bindSkip(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *RolesServiceGetRolePermissionsParams) bindSortBy0Direction(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *RolesServiceGetRolePermissionsParams) bindSortBy0Name(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *RolesServiceGetRolePermissionsParams) bindSortBy0Priority(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *RolesServiceGetRolePermissionsParams) bindTake(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
