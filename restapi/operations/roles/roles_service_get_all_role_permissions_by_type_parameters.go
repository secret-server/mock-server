...
// RolesServiceGetAllRolePermissionsByTypeParams contains all the bound params for the roles service get all role permissions by type operation
// typically these are obtained from a http.Request
//
// swagger:parameters RolesService_GetAllRolePermissionsByType
...
//
// To ensure default values, the struct must have been initialized with NewRolesServiceGetAllRolePermissionsByTypeParams() beforehand.
func (o *RolesServiceGetAllRolePermissionsByTypeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RolesServiceGetAllRolePermissionsByTypeParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *RolesServiceGetAllRolePermissionsByTypeParams) bindSkip(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *RolesServiceGetAllRolePermissionsByTypeParams) bindSortBy0Direction(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *RolesServiceGetAllRolePermissionsByTypeParams) bindSortBy0Name(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *RolesServiceGetAllRolePermissionsByTypeParams) bindSortBy0Priority(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *RolesServiceGetAllRolePermissionsByTypeParams) bindTake(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
