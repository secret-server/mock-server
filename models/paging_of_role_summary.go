...
// PagingOfRoleSummary Specify paging and sorting options for querying records and returning results
//
// swagger:model PagingOfRoleSummary
type PagingOfRoleSummary struct {
...
// Validate validates this paging of role summary
func (m *PagingOfRoleSummary) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PagingOfRoleSummary) validateRecords(formats strfmt.Registry) error {
...
func (m *PagingOfRoleSummary) validateSeverity(formats strfmt.Registry) error {
...
func (m *PagingOfRoleSummary) validateSortBy(formats strfmt.Registry) error {
...
// ContextValidate validate this paging of role summary based on the context it is used
func (m *PagingOfRoleSummary) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PagingOfRoleSummary) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfRoleSummary) contextValidateSeverity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfRoleSummary) contextValidateSortBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfRoleSummary) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PagingOfRoleSummary) UnmarshalBinary(b []byte) error {
	var res PagingOfRoleSummary
