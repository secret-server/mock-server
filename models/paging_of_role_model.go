...
// PagingOfRoleModel Specify paging and sorting options for querying records and returning results
//
// swagger:model PagingOfRoleModel
type PagingOfRoleModel struct {
	...
	// Query results
	Records []*RoleModel `json:"records"`
...
// Validate validates this paging of role model
func (m *PagingOfRoleModel) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PagingOfRoleModel) validateRecords(formats strfmt.Registry) error {
...
func (m *PagingOfRoleModel) validateSeverity(formats strfmt.Registry) error {
...
func (m *PagingOfRoleModel) validateSortBy(formats strfmt.Registry) error {
...
// ContextValidate validate this paging of role model based on the context it is used
func (m *PagingOfRoleModel) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PagingOfRoleModel) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfRoleModel) contextValidateSeverity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfRoleModel) contextValidateSortBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfRoleModel) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PagingOfRoleModel) UnmarshalBinary(b []byte) error {
	var res PagingOfRoleModel
