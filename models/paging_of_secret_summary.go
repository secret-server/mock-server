...
// PagingOfSecretSummary Specify paging and sorting options for querying records and returning results
//
// swagger:model PagingOfSecretSummary
type PagingOfSecretSummary struct {
...
// Validate validates this paging of secret summary
func (m *PagingOfSecretSummary) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PagingOfSecretSummary) validateRecords(formats strfmt.Registry) error {
...
func (m *PagingOfSecretSummary) validateSeverity(formats strfmt.Registry) error {
...
func (m *PagingOfSecretSummary) validateSortBy(formats strfmt.Registry) error {
...
// ContextValidate validate this paging of secret summary based on the context it is used
func (m *PagingOfSecretSummary) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PagingOfSecretSummary) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfSecretSummary) contextValidateSeverity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfSecretSummary) contextValidateSortBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfSecretSummary) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PagingOfSecretSummary) UnmarshalBinary(b []byte) error {
	var res PagingOfSecretSummary
