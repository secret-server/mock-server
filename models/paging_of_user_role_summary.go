...
// PagingOfUserRoleSummary Specify paging and sorting options for querying records and returning results
//
// swagger:model PagingOfUserRoleSummary
type PagingOfUserRoleSummary struct {
	...
	// Query results
	Records []*UserRoleSummary `json:"records"`
...
// Validate validates this paging of user role summary
func (m *PagingOfUserRoleSummary) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PagingOfUserRoleSummary) validateRecords(formats strfmt.Registry) error {
...
func (m *PagingOfUserRoleSummary) validateSeverity(formats strfmt.Registry) error {
...
func (m *PagingOfUserRoleSummary) validateSortBy(formats strfmt.Registry) error {
...
// ContextValidate validate this paging of user role summary based on the context it is used
func (m *PagingOfUserRoleSummary) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PagingOfUserRoleSummary) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfUserRoleSummary) contextValidateSeverity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfUserRoleSummary) contextValidateSortBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfUserRoleSummary) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PagingOfUserRoleSummary) UnmarshalBinary(b []byte) error {
	var res PagingOfUserRoleSummary
