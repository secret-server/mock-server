...
// PagingOfUserLookup Specify paging and sorting options for querying records and returning results
//
// swagger:model PagingOfUserLookup
type PagingOfUserLookup struct {
	...
	// Query results
	Records []*UserLookup `json:"records"`
...
// Validate validates this paging of user lookup
func (m *PagingOfUserLookup) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PagingOfUserLookup) validateRecords(formats strfmt.Registry) error {
...
func (m *PagingOfUserLookup) validateSeverity(formats strfmt.Registry) error {
...
func (m *PagingOfUserLookup) validateSortBy(formats strfmt.Registry) error {
...
// ContextValidate validate this paging of user lookup based on the context it is used
func (m *PagingOfUserLookup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PagingOfUserLookup) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfUserLookup) contextValidateSeverity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfUserLookup) contextValidateSortBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfUserLookup) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PagingOfUserLookup) UnmarshalBinary(b []byte) error {
	var res PagingOfUserLookup
