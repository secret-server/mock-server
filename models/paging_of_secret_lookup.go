...
// PagingOfSecretLookup Specify paging and sorting options for querying records and returning results
//
// swagger:model PagingOfSecretLookup
type PagingOfSecretLookup struct {
	...
	// Query results
	Records []*SecretLookup `json:"records"`
...
// Validate validates this paging of secret lookup
func (m *PagingOfSecretLookup) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PagingOfSecretLookup) validateRecords(formats strfmt.Registry) error {
...
func (m *PagingOfSecretLookup) validateSeverity(formats strfmt.Registry) error {
...
func (m *PagingOfSecretLookup) validateSortBy(formats strfmt.Registry) error {
...
// ContextValidate validate this paging of secret lookup based on the context it is used
func (m *PagingOfSecretLookup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PagingOfSecretLookup) contextValidateRecords(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfSecretLookup) contextValidateSeverity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfSecretLookup) contextValidateSortBy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PagingOfSecretLookup) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PagingOfSecretLookup) UnmarshalBinary(b []byte) error {
	var res PagingOfSecretLookup
